...
namespace Gaia.Pipeline
{
    ...
    /// its replacement shader in the URP and HDRP pipeline. The entry also contains a list of all materials using this shader so they can be switched to the new shader easily.
    /// </summary>
    [System.Serializable]
    ...
    public class UnityPipelineProfile : ScriptableObject
    {
        ...
        [Header("Pipeline Supported Versions 2019.3")]
        [HideInInspector]
        public string m_min2019_3LWVersion = "5.7.2";
        [HideInInspector]
        public string m_max2019_3LWVersion = "5.13.0";
        [HideInInspector]
        public string m_min2019_3HDVersion = "5.7.2";
        [HideInInspector]
        public string m_max2019_3HDVersion = "5.13.0";
        [HideInInspector]
        public string m_min2019_3UPVersion = "5.7.2";
        [HideInInspector]
        public string m_max2019_3UPVersion = "5.13.0";
        ...
        [HideInInspector]
        public MaterialLibraryEntry[] m_materialLibrary;
