...
namespace Gaia.GX.ProceduralWorlds
{
    public class GaiaSkiesGX
    {
        ...
        #if GAIA_PRO_PRESENT
        /// <summary>
        /// Adds global vegetation settings to the scene
        /// </summary>
        public static void GX_Vegetation_AddGlobalWindController()
        {
            GaiaSettings gaiaSettings = GaiaUtils.GetGaiaSettings();
            ProceduralWorldsGlobalWeather.AddGlobalWindShader(gaiaSettings.m_windType);
        }

        /// <summary>
        /// Removes global vegetation settings to the scene
        /// </summary>
        public static void GX_Vegetation_RemoveGlobalWindController()
        {
        ...
        public static void GX_Lightmaps_BakeLighting()
        {
            ...
            if (settings != null)
            {
                GaiaLighting.BakeLighting(settings.m_gaiaLightingProfile);
            }
        }
