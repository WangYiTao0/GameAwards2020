...
namespace Gaia
{
    public class SelectProfileWindowEditor : EditorWindow
    {
        ...
        private void Water()
        {
            ...
            m_gaiaSettings.m_selectedWaterProfile = EditorGUILayout.Popup(m_gaiaSettings.m_selectedWaterProfile, WaterList.ToArray());
            if (GUILayout.Button("Edit"))
            {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                GaiaWater.GetProfile(m_gaiaSettings.m_selectedWaterProfile, waterMat, m_waterProfile, m_gaiaSettings.m_pipelineProfile.m_activePipelineInstalled, true, false);
            }
        }
