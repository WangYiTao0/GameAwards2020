        ...
        private void GlobalSettingsPanel(bool helpEnabled)
        {
            ...
            if (GaiaProUtils.IsGaiaPro())
            {
                ...
                if (ProceduralWorldsGlobalWeather.Instance != null)
                {
                    ...
                    EditorGUI.indentLevel++;
                    bool snowCheckActive = ProceduralWorldsGlobalWeather.Instance.m_player.transform.position.y > ProceduralWorldsGlobalWeather.Instance.SnowHeight;
                    bool rainCheckActive = ProceduralWorldsGlobalWeather.Instance.m_player.transform.position.y < ProceduralWorldsGlobalWeather.Instance.SnowHeight;
