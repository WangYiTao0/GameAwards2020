...
namespace Gaia
{
    ...
    public class SpawnerEditor : PWEditor, IPWEditor
    {
        ...
        {
            get {   if (m_baseTerrainStamper == null)
                    { 
...
#region SPAWNER MASK LIST MANAGEMENT
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_spawner.m_massStampRunning)
            {
                //Check if the mass stamping is still running
                if (SessionManager.m_massStamperSettingsList != null)
                {
                    ...
                    {
                        GUI.enabled = true;
                        m_spawner.m_massStampRunning = false;
                    }
                }
                else
                {
            ...
            if (m_spawner.m_settings.m_isWorldmapSpawner)
            {
                ...
                m_editorUtils.Panel("SaveLoad", DrawSaveAndLoad);
                ...
                if (m_editorUtils.ButtonAutoIndent("ExportTerrainButtonExport"))
                {
                    try
                    {
                        if (!m_spawner.m_useExistingTerrainForWorldMapExport)
                        {
                            ...
                            GaiaUtils.DisplayProgressBarNoEditor("Export To World", "Creating Terrain Tiles for the Export...", 0.3f);
                        ...
                        GaiaUtils.DisplayProgressBarNoEditor("Export To World", "Syncing World Map to World...", 0.3f);
                        GameObject wmeGO = GaiaUtils.GetOrCreateWorldDesigner();
                        wmeGO.GetComponent<WorldMap>().SyncWorldMapToLocalMap();
                        GaiaUtils.DisplayProgressBarNoEditor("Export To World", "Updating Stamps...", 0.3f);
                        ...
                        {
                            GaiaUtils.DisplayProgressBarNoEditor("Export To World", "Stamping...", 0.6f);
                            GaiaSessionManager.MassStamp(m_spawner.m_worldMapStamperSettings, true);
                            m_spawner.m_massStampRunning = true;
        ...
        private void DrawClearControls(bool helpEnabled)
        {
            ...
            //        m_spawner.ClearAllSpawnExtensions();
            //    }
            //}
        ...
        private void RefreshTerrainPrototype(int spawnRuleID, Texture2D oldTexture = null, GameObject oldGameObject = null, int substanceIdx = 0)
        {
        ...
        private void DrawSaveAndLoad(bool obj)
        {
            ...
            if (m_editorUtils.Button("SaveButton"))
            {
                ...
                string filename = "SpawnerSettings";
