    ...
    public static class GaiaHDRPPipelineUtils
    {
        ...
        public static void CleanUpHDRP(UnityPipelineProfile profile, GaiaSettings gaiaSettings)
        {
            ...
            if (waterPrefab != null)
            {
                ...
                if (waterMat != null)
                {
                    GaiaWater.GetProfile(gaiaSettings.m_selectedWaterProfile, waterMat, gaiaSettings.m_gaiaWaterProfile, gaiaSettings.m_pipelineProfile.m_activePipelineInstalled, true, false);
                }
                else
                {
