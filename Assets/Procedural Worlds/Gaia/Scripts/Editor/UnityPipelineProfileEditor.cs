...
namespace Gaia.Pipeline
{
    ...
    public class UnityPipelineProfileEditor : PWEditor
    {
        ...
        private void PipelineVersionSettingsEnabled(bool helpEnabled)
        {
            ...
            {
                GUILayout.BeginHorizontal();
                EditorGUILayout.LabelField("Minimum LWRP Version " + m_profile.m_min2019_3LWVersion);
                EditorGUILayout.LabelField("Maximum LWRP Version " + m_profile.m_max2019_3LWVersion);
                GUILayout.EndHorizontal();
        ...
        private void ProfileSettingsEnabled(bool helpEnabled)
        {
            ...
            GUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("Minimum LWRP Version ");
            m_profile.m_min2019_3LWVersion = EditorGUILayout.TextArea(m_profile.m_min2019_3LWVersion);
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("Maximum LWRP Version ");
            m_profile.m_max2019_3LWVersion = EditorGUILayout.TextArea(m_profile.m_max2019_3LWVersion);
            GUILayout.EndHorizontal();
