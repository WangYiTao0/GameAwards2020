...
namespace Gaia
{
    ...
    public class ScannerEditor : PWEditor
    {
        ...
        private void GlobalPanel(bool helpEnabled)
        {
            ...
            m_scanner.m_featureName = m_editorUtils.TextField("FeatureName", m_scanner.m_featureName, helpEnabled);
            m_scanner.m_featureType = (GaiaConstants.FeatureType)m_editorUtils.EnumPopup("FeatureType", m_scanner.m_featureType, helpEnabled);
