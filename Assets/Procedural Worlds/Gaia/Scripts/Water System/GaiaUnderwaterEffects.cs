...
namespace Gaia
{
    public class GaiaUnderwaterEffects : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                m_underwaterMaterial = GetUnderwaterMaterial();
            }
            else
            {
        ...
        {
            m_underwaterMaterial.SetColor("_UnderWaterColor", m_fogColor);
        }
        ...
        /// <summary>
        /// Gets the underwater material
        /// </summary>
        /// <returns></returns>
        private Material GetUnderwaterMaterial()
        {
            Material underwaterMaterial = null;
            Material[] materials = null;

            GameObject oceanObj = GameObject.Find("Water Surface");
            if (oceanObj != null)
            {
                MeshRenderer meshRenderer = oceanObj.GetComponent<MeshRenderer>();
                if (meshRenderer != null)
                {
                    materials = meshRenderer.sharedMaterials;
                    foreach (Material material in materials)
                    {
                        if (material.name == "Gaia Ocean Underwater")
                        {
