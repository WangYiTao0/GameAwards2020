...
namespace Gaia.GX.ProceduralWorlds
{
    public class GaiaWaterGX
    {
        ...
        public static void GX_WaterSetup_AddWater()
        {
            ...
            if (material != null)
            {
                GaiaWater.GetProfile(0, material, waterProfile, gaiaSettings.m_pipelineProfile.m_activePipelineInstalled, true, false);
            }
            else
            {
        ...
        {
            GaiaSettings gaiaSettings = GaiaUtils.GetGaiaSettings();
            GaiaWater.SetWaterReflectionsType(true, gaiaSettings.m_pipelineProfile.m_activePipelineInstalled, gaiaSettings.m_gaiaWaterProfile, gaiaSettings.m_gaiaWaterProfile.m_waterProfiles[gaiaSettings.m_selectedWaterProfile]);
        }
        ...
        {
            GaiaSettings gaiaSettings = GaiaUtils.GetGaiaSettings();
            GaiaWater.SetWaterReflectionsType(false, gaiaSettings.m_pipelineProfile.m_activePipelineInstalled, gaiaSettings.m_gaiaWaterProfile, gaiaSettings.m_gaiaWaterProfile.m_waterProfiles[gaiaSettings.m_selectedWaterProfile]);
        }      
