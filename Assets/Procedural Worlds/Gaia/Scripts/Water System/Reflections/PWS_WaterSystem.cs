...
namespace ProcedualWorlds.WaterSystem
{
    ...
    public class PWS_WaterSystem : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (m_gaiaSession != null)
            {
                SeaLevel = m_gaiaSession.GetSeaLevel();
            }
        ...
        private void Update()
        {
            ...
            if (m_waterProfile != null)
            {
                m_waterProfileValues = m_waterProfile.m_waterProfiles[m_gaiaSettings.m_selectedWaterProfile];
            }
        ...
        private void BuildWaterColorDepth()
        {
            ...
            if (m_waterRenderer != null && m_waterTexture != null)
            {
        ...
        private void BuildReflection(bool renderOnlySkybox)
        {
            ...
            if (Application.isPlaying)
            {
                ...
                {
                    if (m_player.position.y > m_disableHeight)
                    {
        ...
        public void UpdateShaderValues()
        {
            ...
            else
            {
                ...
                else
                {
                    if (SunLight != null)
                    {
                        m_specColor = GaiaUtils.GetColorFromHTML("444444");
