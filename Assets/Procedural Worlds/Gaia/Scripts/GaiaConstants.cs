...
namespace Gaia
{
    public static class GaiaConstants
    {
        ...
        /// </summary>
        public enum FeatureOperation { RaiseHeight=0, LowerHeight=1, BlendHeight=2, SetHeight=3, AddHeight=4, SubtractHeight=5, HeightTransform = 10, PowerOf = 11, Smooth = 12, Contrast =6, SharpenRidges=7, Terrace=8, HydraulicErosion=9  };
