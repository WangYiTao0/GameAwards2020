...
namespace Gaia
{
    ...
    public class BiomeController : MonoBehaviour
    {
        ...
        {
            GaiaUtils.DisplayProgressBarNoEditor("Removing Foreign Trees", "Removing...", 0);
        ...
        {
            GaiaUtils.DisplayProgressBarNoEditor("Removing Foreign GameObjects", "Removing...", 0);
                ...
                foreach (SpawnRule sr in spawner.m_settings.m_spawnerRules)
                {
                    if (sr.m_resourceType == GaiaConstants.SpawnerResourceType.GameObject)
                    {
                        ...
                        foreach (ResourceProtoGameObjectInstance instance in protoGO.m_instances)
                        {
                            ...
                            {
                                operation.SetTerrainGameObjects(ApplyBrush(operation, MultiTerrainOperationType.GameObject), protoGO, sr, GaiaConstants.SpawnMode.Remove, 0, ref sr.m_spawnedInstances, m_settings.m_removeForeignGameObjectStrength,false,GaiaSettings.m_hideObjectsInHierachy);
        ...
        {
            GaiaUtils.DisplayProgressBarNoEditor("Removing Foreign Terrain Details", "Removing...", 0.5f);
            ...
            GaiaUtils.DisplayProgressBarNoEditor("Removing Foreign Terrain Details", "Removing Terrain Details...", 0.5f);
